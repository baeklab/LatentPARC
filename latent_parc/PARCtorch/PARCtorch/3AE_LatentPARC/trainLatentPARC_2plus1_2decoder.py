...
weights_name="LP_2plus1_2decoder_Nmax16_nrf8_redon500_LRstep_e3_factor8_stepsize200_nts1_HALVEDms"
...
decoder_TP = Decoder(layers=layer_sizes_TP, latent_dim=latent_dim_TP).to(device)
...
model_init = lp_model_2plus1_2decoder(encoder_TP, encoder_M, decoder_TP,
                                        decoder_M, differentiator, 
