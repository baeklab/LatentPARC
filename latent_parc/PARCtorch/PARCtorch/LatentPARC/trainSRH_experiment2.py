...
from autoencoder.loss_funcs import FFTLoss, PhaseFFTLoss
...
N_REDUCE_FACTOR     = 0.8        # Factor by which noise is reduced
...
sr_ae.load_state_dict(ckpt["model_state_dict"], strict=False)
...
# Optionally freeze encoder and decoder
if FREEZE_AE:
