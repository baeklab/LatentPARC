...
#         # block 1
#         self.b1c1 = nn.Conv2d(in_channels, 32, kernel_size=3, padding=1)  
#         self.b1c2 = nn.Conv2d(32, 32, kernel_size=3, padding=1)
#         self.b1c3 = nn.Conv2d(32, 32, kernel_size=3, padding=1)
        
#         # block 2
#         self.b2c1 = nn.Conv2d(32, 64, kernel_size=3, padding=1)
#         self.b2c2 = nn.Conv2d(64, 64, kernel_size=3, padding=1)
#         self.b2c3 = nn.Conv2d(64, 64, kernel_size=3, padding=1)
        
#         #block 3
#         self.b3c1 = nn.Conv2d(64, 64, kernel_size=7, padding=3)
#         self.b3c2 = nn.Conv2d(64, 32, kernel_size=1, padding=0)
#         self.b3c3 = nn.Conv2d(32, 32, kernel_size=1, padding=0)
...
#         b3c3 = self.leaky_relu(self.b3c3(b3c2))
#         b3c3 = self.dropout(b3c3)
...
# # 2x depth + correct (less) activations
# class Differentiator(nn.Module):
#     def __init__(self, latent_dim):
#         super().__init__()
