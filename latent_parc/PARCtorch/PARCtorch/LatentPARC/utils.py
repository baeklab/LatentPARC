## TODO: eventually want to do ratio plots, etc. here, or move those metrics to a metrics specific file
## TODO: make a unified visualization (plotting + GIFs) file between LP and autoencoder
...
def save_model_and_logs(
    ...
    ckpt_path = f"{save_path}/{weights_name}_{epochs+1}.pth"
    torch.save(checkpoint, ckpt_path)

    log_path = f"{save_path}/{weights_name}_{epochs+1}.json"
