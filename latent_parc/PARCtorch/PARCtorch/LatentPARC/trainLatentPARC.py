...
save_path="/sfs/gpfs/tardis/home/pdy2bw/Research/LatentPARC/latent_parc/PARCtorch/PARCtorch/LatentPARC"
weights_name="2xDepth_ONEQUARTERms_layers_3_8_latent_16_DE_Nmax16_nrf8_redon500_LRstep_e3_factor8_stepsize200_nts1"
...
integrator = RK4().cuda()  # step size may be hyper-param of interest
...
log_dict = model.train(criterion, epochs=5000, image_size = [128, 256], n_channels=3, device=device,
                        train_loader=train_loader, val_loader=val_loader, scheduler=scheduler, noise_fn=add_random_noise, initial_max_noise=0.16, n_reduce_factor=.8, reduce_on=200)
