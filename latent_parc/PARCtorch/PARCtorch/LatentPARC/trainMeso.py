...
IMAGE_SIZE          = [680, 1000] # [680, 1000] meso, [128, 256] single
N_CHANNELS          = 3
...
# scheduler = "step" # options None, step
scheduler = None
...
WEIGHTS_NAME        = "single_void_basicAE_rollout5_bs1_NoScheduler_lr1e5_MESO_350plus"

# ── Flags ─────────────────────────────────────────────────────────────────────
FREEZE_AE           = True       # Freeze autoencoder weights during training
LOAD_WEIGHTS        = True      # Load checkpoint to resume training
LOAD_WEIGHTS_PATH   = "weights/single_void_basicAE_rollout5_bs1_NoScheduler_lr1e5_MESO_350.pth" # Path to checkpoint (only used if LOAD_WEIGHTS=True)
