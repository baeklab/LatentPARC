...
AE_WEIGHTS_PATH     = "autoencoder/weights/SRH_frozenBasicAE_OutActSigmoid_1000.pth"
SAVE_PATH           = f"{BASE_PATH}/LatentPARC/latent_parc/PARCtorch/PARCtorch/LatentPARC/weights"
WEIGHTS_NAME        = "single_void_SRHfrozenBasicAE_SigOut_rollout5_bs1_NoScheduler_LR1e5"
...
sr_ae = SuperResHeadAutoencoder(layers=LAYER_SIZES, latent_dim=LATENT_DIM, act_fn=nn.ReLU(), out_act=nn.Sigmoid()).to(device)
